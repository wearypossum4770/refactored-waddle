  ...
  (a.dev = !1),
          ...
          function m() {
            ...
            h.elementMousemove({ mouseX: d, mouseY: e, pointXValue: l }),
              "dblclick" === d3.event.type &&
                h.elementDblclick({ mouseX: d, mouseY: e, pointXValue: l }),
              "click" === d3.event.type &&
                h.elementClick({ mouseX: d, mouseY: e, pointXValue: l });
          }
      ...
      return (
        ...
        (b.margin = function (a) {
          return arguments.length
            ? ((f.top = "undefined" != typeof a.top ? a.top : f.top),
              (f.left = "undefined" != typeof a.left ? a.left : f.left),
              b)
            : f;
        }),
        (b.width = function (a) {
          ...
          C = function (b) {
            o &&
              a.dom.read(function () {
                ...
                (j =
                  window.innerWidth >= document.body.scrollWidth ? j : j - 16),
                  (i =
                ...
                var r,
                  ...
                  v = function (a) {
                    var b = c;
                    do
                      isNaN(a.offsetLeft) || (b += a.offsetLeft),
                        (a = a.offsetParent);
                    while (a);
                    return b;
                  };
                ...
                var w = o.getBoundingClientRect(),
                  ...
                  x =
                    "translate(" + (w.left + p) + "px, " + (w.top + k) + "px)",
                  ...
                  i &&
                    ...
                    x
                      ...
                      .attr("transform", function (b, c) {
                        return (
                          "translate(" + a.utils.NaNtoZero(d.range()[c]) + ",0)"
                        );
                      }));
                break;
              case "bottom":
                ...
                v.enter().append("text").attr("class", "nv-axislabel"),
                  ...
                  i &&
                    ...
                    x
                      .watchTransition(s, "min-max bottom")
                      .attr("transform", function (b) {
                        return (
                          "translate(" +
                          a.utils.NaNtoZero(
                ...
                v.enter().append("text").attr("class", "nv-axislabel"),
                  ...
                  i &&
                    ...
                    x
                      ...
                      .attr("transform", function (b, c) {
                        return (
                          "translate(0," + a.utils.NaNtoZero(d.range()[c]) + ")"
                        );
                      })
                      .select("text")
                      .style("opacity", 1));
            ...
            if (
              ...
              p.selectAll("g.nv-axisMaxMin").each(function (a, b) {
                try {
                  E.push(
                    b
                      ? d(a) - this.getBoundingClientRect().width - 4
                      : d(a) + this.getBoundingClientRect().width + 4
                  );
                } catch (c) {
          ...
          l.each(function (b) {
            ...
            if (!d) {
              var x = d3.min(
                  b.map(function (a) {
                    ...
                    return (
                      b.push(a.values.Q1),
                      a.values.hasOwnProperty("whisker_low") &&
                        null !== a.values.whisker_low &&
                        b.push(a.values.whisker_low),
                      a.values.hasOwnProperty("outliers") &&
                ...
                y = d3.max(
                  b.map(function (a) {
                    ...
                    return (
                      b.push(a.values.Q3),
                      a.values.hasOwnProperty("whisker_high") &&
                        null !== a.values.whisker_high &&
            ...
            A.attr("class", "nv-boxplot")
              .attr("transform", function (a, b) {
                return (
                  "translate(" + (m(o(a, b)) + 0.05 * m.rangeBand()) + ", 0)"
                );
              })
          ...
          k.each(function (k) {
            ...
            if (
              ...
              f
                ...
                z
                  .select(".nv-x.nv-axis")
                  .attr("transform", "translate(0," + d.range()[0] + ")"),
          ...
          d.each(function (b, d) {
            ...
            F.selectAll("path.nv-markerTriangle")
              ...
              D.selectAll(".nv-range")
                .on("mouseover", function (a, b) {
                  var c =
                    w[b] || (b ? (1 == b ? "Mean" : "Minimum") : "Maximum");
                  r.elementMouseover({
                    value: a,
                    label: c,
                    color: d3.select(this).style("fill"),
        ...
        (b._options = Object.create(
          {},
          {
            ...
            tooltips: {
              ...
              set: function (b) {
                a.deprecated("tooltips", "use chart.tooltip.enabled() instead"),
                  d.enabled(!!b);
              },
            },
            tooltipContent: {
            ...
            l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
              l.range(
                v
                  ? f || [
                      ...
                      (x * (b[0].values.length - 0.5)) / b[0].values.length,
                    ]
                  : f || [5 + A / 2, x - A / 2 - 5]
              ),
              m
              ...
              l.domain()[0] === l.domain()[1] &&
                l.domain(
                  l.domain()[0]
                    ? [
                        l.domain()[0] - 0.01 * l.domain()[0],
                        l.domain()[1] + 0.01 * l.domain()[1],
                      ]
                    : [-1, 1]
                ),
              m.domain()[0] === m.domain()[1] &&
                m.domain(
                  m.domain()[0]
                    ? [
                        m.domain()[0] + 0.01 * m.domain()[0],
                        m.domain()[1] - 0.01 * m.domain()[1],
                      ]
                    : [-1, 1]
                );
            var B = d3
      ...
      function b(l) {
        return (
          ...
          l.each(function (l) {
            ...
            U.attr("transform", "translate(" + m.left + "," + m.top + ")"),
              t &&
                ...
                if (
                  (l
                    ...
                    .forEach(function (g, h) {
                      (e = a.interactiveBisect(g.values, c.pointXValue, b.x())),
                  ...
                  var o = b.yScale().invert(c.mouseY),
                    p = Math.abs(
                      b.yScale().domain()[0] - b.yScale().domain()[1]
                    ),
                    q = 0.03 * p,
              ...
              f
                ...
                x
                  ...
                  .attr(
                    ...
                    "translate(0," +
                      (d.range()[0] +
                        (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) +
                      ")"
                  ),
    ...
    (a.models.distribution = function () {
      ...
      function b(k) {
        return (
          ...
          k.each(function (b) {
            var k =
                (e - ("x" === g ? d.left + d.right : d.top + d.bottom),
                "x" == g ? "y" : "x"),
              l = d3.select(this);
          ...
          p.each(function (b) {
            ...
            if (h) {
              ...
              w.each(function () {
                ...
                try {
                  if (((b = c.node().getComputedTextLength()), 0 >= b))
                    throw Error();
                } catch (d) {
              ...
              w.attr("transform", function (a, b) {
                ...
                j
                  ? u.attr(
                      "transform",
                      "translate(" + (d - c.right - D) + "," + c.top + ")"
                    )
                  : u.attr("transform", "translate(0," + c.top + ")"),
              ...
              w.attr("transform", function () {
                ...
                return (
                  (J = L),
                  d < c.left + c.right + J + a && ((L = J = 5), (K += A)),
                  (L += a),
                  L > M && (M = L),
                  "translate(" + J + "," + K + ")"
                );
        ...
        return (
          x.each(function (b) {
            ...
            a.utils.initSVG(k),
              ...
              m
                .domain(d || d3.extent(b[0].values.map(o).concat(q)))
                .range(f || [y, 0]),
              l.domain()[0] === l.domain()[1] &&
                l.domain(
                  l.domain()[0]
            ...
            E.exit().remove(),
              E.enter()
                ...
                .attr("transform", function (a, c) {
                  return (
                    "translate(" +
                    (l(n(a, c)) - (x / b[0].values.length) * 0.45) +
                    ",0)"
                  );
                })
                .on("mouseover", function (a, b) {
              ...
              E.attr("fill", function (a, b) {
                ...
                .attr("class", function (a, b, c) {
                  return (
                    (o(a, b) < 0 ? "nv-bar negative" : "nv-bar positive") +
                    " nv-bar-" +
                    c +
                    "-" +
                    b
                ...
                (a.disabled = !a.disabled),
                  k.filter(function (a) {
                    ...
                    k.map(function (a) {
                      return (
                        (a.disabled = !1),
                        E.selectAll(".nv-series").classed("disabled", !1),
                        a
                      );
                    }),
                  (u.disabled = k.map(function (a) {
      ...
      function b(p) {
        function q(a, b) {
          return "furious" != o
            ...
            : m
            ? void 0
            : (a.color || (a.color = g(a, b)), a.disabled ? a.color : "#fff");
        }
        function r(a, b) {
            ...
            if (h) {
              ...
              y.attr("transform", function (a, b) {
                ...
                j
                  ? v.attr(
                      "transform",
                      "translate(" + (d - c.right - C) + "," + c.top + ")"
                    )
                  : v.attr("transform", "translate(0," + c.top + ")"),
              ...
              y.attr("transform", function () {
                ...
                return (
                  (K = M),
                  d < c.left + c.right + K + a && ((M = K = 5), (L += x)),
                  (M += a),
                  M > N && (N = M),
                  K + N > C && (C = K + N),
                  "translate(" + K + "," + L + ")"
          ...
          v.each(function (v) {
            ...
            if (
              ...
              t.width(gb),
                ...
                db
                  .select(".nv-legendWrap")
                  .attr("transform", "translate(" + hb + "," + -w.top + ")");
            }
            ...
            db
              .select(".nv-context")
              .attr("transform", "translate(0," + (W + w.bottom + x.top) + ")"),
        ...
        return (
          o.each(function (o) {
            ...
            var O = I.selectAll("g.nv-wrap.nv-lineWithFocusChart").data([o]),
              P = O.enter()
                .append("g")
                .attr("class", "nvd3 nv-wrap nv-lineWithFocusChart")
                .append("g"),
              Q = O.select("g");
      ...
      function b(E) {
        return (
          ...
          E.each(function (b) {
            ...
            m
                    ...
                    d3.extent(
                      d3
                        ...
                        .map(function (a) {
                          ...
                          return (
                            u &&
                              !b[a.idx].nonStackable &&
                              (c = a.y > 0 ? a.y1 : a.y1 + a.y),
                            c
                          );
                        })
                        .concat(s)
              ...
              n.domain()[0] === n.domain()[1] &&
                n.domain(
                  n.domain()[0]
                    ? [
                        n.domain()[0] + 0.01 * n.domain()[0],
                        n.domain()[1] - 0.01 * n.domain()[1],
                      ]
                    : [-1, 1]
                ),
              (h = h || m),
            ...
            var R = Q.watchTransition(C, "multibar", Math.min(250, z)).delay(
              function (a, c) {
              ...
              ? R.attr("y", function (a, c, d) {
                  ...
                  .attr("height", function (a, c, d) {
                    return b[d].nonStackable
                      ? Math.max(Math.abs(n(r(a, c)) - n(0)), 1) || 0
                      : Math.max(Math.abs(n(a.y + a.y0) - n(a.y0)), 1);
                  })
                  .attr("x", function (a, c, d) {
                    var e = 0;
                    return (
                      b[d].nonStackable &&
                        ...
                        b.length !== G &&
                          (e =
                            (b[d].nonStackableSeries * m.rangeBand()) /
                            (2 * G))),
                      e
                    );
                  })
          ...
          j.each(function (j) {
            ...
            if ((N.call(e), r)) {
              ...
              if ((O.selectAll("line, text").style("opacity", 1), v)) {
                ...
                var S = d3.selectAll(".nv-x.nv-axis .nv-wrap g g text")[0]
                  .length;
                L.selectAll(".nv-x.nv-axis .nv-axisMaxMin text").attr(
                  "transform",
                  function (a, b) {
        ...
        return (
          ...
          m.each(function (b) {
            ...
            I.append("g").attr("class", "nv-groups"),
              G.attr("transform", "translate(" + j.left + "," + j.top + ")");
            ...
            J.enter()
              ...
              .style("fill-opacity", 1e-6),
              J.exit()
                .watchTransition(E, "multibarhorizontal: exit groups")
                .style("stroke-opacity", 1e-6)
                .style("fill-opacity", 1e-6)
                .remove(),
                ...
                ? (K.select("text")
                    ...
                    .text(function (a, b) {
                      ...
                      return void 0 === d
                        ? c
                        : d.length
                        ? c + "+" + B(Math.abs(d[1])) + "-" + B(Math.abs(d[0]))
                        : c + "±" + B(Math.abs(d));
                    }),
                ...
                : K.watchTransition(E, "multibarhorizontal: bars")
                    .attr("transform", function (a, c) {
                      return (
                        ...
                        p(r(a, c) < 0 ? r(a, c) : 0) +
                        "," +
                        ((a.series * o.rangeBand()) / b.length + o(q(a, c))) +
                        ")"
                      );
                    })
                    .select("rect")
            ...
            r
              ...
              .color(
                Q.filter(function (a, b) {
                  return (
                    !j[b].disabled && 1 == j[b].yAxis && "line" == j[b].type
                  );
                })
              ),
              s
                ...
                .color(
                  Q.filter(function (a, b) {
                    return (
                      !j[b].disabled && 2 == j[b].yAxis && "line" == j[b].type
                    );
                  })
                ),
              t
                ...
                .color(
                  Q.filter(function (a, b) {
                    return (
                      !j[b].disabled && 1 == j[b].yAxis && "bar" == j[b].type
                    );
                  })
                ),
              u
                ...
                .color(
                  Q.filter(function (a, b) {
                    return (
                      !j[b].disabled && 2 == j[b].yAxis && "bar" == j[b].type
                    );
                  })
                ),
              v
                ...
                .color(
                  Q.filter(function (a, b) {
                    return (
                      !j[b].disabled && 1 == j[b].yAxis && "area" == j[b].type
                    );
                  })
                ),
              w
                ...
                .color(
                  Q.filter(function (a, b) {
                    return (
                      !j[b].disabled && 2 == j[b].yAxis && "area" == j[b].type
                    );
                  })
                ),
              ...
              l.range(
                v
                  ? e || [
                      ...
                      (y * (b[0].values.length - 0.5)) / b[0].values.length,
                    ]
                  : e || [5 + B / 2, y - B / 2 - 5]
              ),
              m
          ...
          p.each(function (b) {
              ...
              (k = []),
                ...
                M.style("display", function (c) {
                  var d = a.every(function (a, d) {
                    return isNaN(c[a]) && b[d][0] == g[a].brush.y().domain()[0]
                      ? !0
                      : b[d][0] <= c[a] && c[a] <= b[d][1];
                  });
            ...
            M.enter().append("path"),
              ...
              M.on("mouseout", function (a, b) {
                d3.select(this).classed("hover", !1),
                  o.elementMouseout({ label: a.name, data: a.data, index: b });
              });
        ...
        (b._options = Object.create(
          {},
          {
            ...
            dimensions: {
              ...
              set: function (b) {
                a.deprecated("dimensions", "use dimensionNames instead"),
                  (h = b);
              },
            },
            margin: {
        ...
        return (
          ...
          E.each(function (b) {
            ...
            if (((i = d3.select(this)), 0 === z.length))
              for (var K = H - H / 5, L = y * H, M = 0; M < b[0].length; M++)
                I.push(K), J.push(L);
            else
              (I = z.map(function (a) {
            ...
            U.padAngle && v && U.padAngle(v),
              p &&
                ...
                N.select(".nv-pie-title")
                  ...
                  .style(
                    "font-size",
                    (Math.min(F, G) * y * 2) / (q.length + 2) + "px"
                  )
                  .attr("dy", "0.35em")
            ...
            if (
              ...
              for (var Y = [], M = 0; M < b[0].length; M++)
                Y.push(B[M]),
                  m
                    ? p &&
                      ((Y[M] = d3.svg.arc().outerRadius(B[M].outerRadius())),
                ...
                .each(function (a) {
                  ...
                  b.attr("transform", function (a, b) {
                    if (t) {
                      ...
                      return (
                        (a.startAngle + a.endAngle) / 2 < Math.PI
                          ? (c -= 90)
                          : (c += 90),
                        "translate(" + Y[b].centroid(a) + ") rotate(" + c + ")"
                      );
                    }
                    return (
                      (a.outerRadius = H + 10),
                      (a.innerRadius = H + 15),
                      "translate(" + Y[b].centroid(a) + ")"
                    );
                  }),
                    b
                      .append("rect")
              ...
              var Z = {},
                ...
                ab = function (a) {
                  return (
                    Math.floor(a[0] / _) * _ + "," + Math.floor(a[1] / $) * $
                  );
                };
      ...
      function b(e) {
        return (
          ...
          e.each(function (e) {
            ...
            t.attr("transform", "translate(" + f.left + "," + f.top + ")"),
              c.width(n).height(o);
          ...
          N.each(function (b) {
            ...
            m.domain(
              ...
              m.range(
                y && b[0]
                  ? G || [
                      (R * z + R) / (2 * b[0].values.length),
                      R - (R * (1 + z)) / (2 * b[0].values.length),
                    ]
                  : G || [0, R]
              ),
              n
            ...
            $.enter()
              ...
              .attr("transform", function (a) {
                return (
                  "translate(" + c(p(a[0], a[1])) + "," + d(q(a[0], a[1])) + ")"
                );
              })
              .attr(
                "d",
        ...
        (b._calls = new (function () {
          (this.clearHighlights = function () {
            ...
            (this.highlightPoint = function (b, c, d) {
              a.dom.write(function () {
                l.select(" .nv-series-" + b + " .nv-point-" + c).classed(
                  "hover",
                  d
                );
              });
          ...
          z.each(function (z) {
            ...
            P.enter()
              ...
              c.dispatch.on("elementMouseover.tooltip", function (a) {
                m
                  .select(
                    ".nv-series-" + a.seriesIndex + " .nv-distx-" + a.pointIndex
                  )
                  ...
                  m
                    ...
                    .attr("x2", a.pos.left + g.size() - j.left),
        ...
        return (
          p.each(function (p) {
            ...
            function r() {
              function a(a, b) {
                for (
                  var c = Math.abs(e.x()(a[0], 0) - b), d = 0, f = 0;
                  f < a.length;
                  f++
                )
          ...
          m.each(function (m) {
            ...
            G.enter()
              ...
              r.dispatch.on("elementMouseover.area", function (a) {
                C.select(
                  ".nv-chart-" + i + " .nv-area-" + a.seriesIndex
                ).classed("hover", !0);
              }),
        ...
        return (
          ...
          k.each(function (k) {
            ...
            if (
              ...
              if (
                ((T =
                  "wiggle" === e.offset() ? 0 : a.utils.calcTicksY(L / 36, k)),
                      ...
                      if (
                        ...
                        "undefined" == typeof d && (d = k),
                          "undefined" == typeof h &&
                            (h = b.xScale()(b.x()(k, g)));
                        var m =
                          "expand" == e.style() ? k.display.y : b.y()(k, g);
                        i.push({
                          key: f.key,
                          value: m,
            ...
            z.attr("transform", "translate(" + w / 2 + "," + x / 2 + ")"),
              ...
              (v = B.data(r.nodes)
                ...
                .on("click", function (a) {
                  d !== c && c !== a && (d = c),
                    (c = a),
                    v.transition().duration(n).attrTween("d", u(a));
                })
                .each(t)
                .on("dblclick", function (a) {
                  d.parent == a &&
                    v.transition().duration(n).attrTween("d", u(e));
                })
                .each(t)
                .on("mouseover", function (a) {
                  d3.select(this).classed("hover", !0).style("opacity", 0.8),
                    o.elementMouseover({
                      data: a,
                      color: d3.select(this).style("fill"),
                    });
    ...
    (a.models.sunburstChart = function () {
        ...
        return (
          ...
          d.each(function (d) {
            ...
            m.append("g").attr("class", "nv-sunburstWrap"),
              l.attr("transform", "translate(" + e.left + "," + e.top + ")"),
              c.width(i).height(j);
      ...
      return (
        ...
        c.dispatch.on("elementMouseover.tooltip", function (a) {
          (a.series = { key: a.data.name, value: a.data.size, color: a.color }),
            d.data(a).hidden(!1);
        }),
        c.dispatch.on("elementMouseout.tooltip", function () {
          d.hidden(!0);
